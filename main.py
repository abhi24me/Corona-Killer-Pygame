...
# Game Over Text
over_font = pygame.font.Font("GameOverFont.ttf", 78)


def show_score(x, y):
    score = font.render("score : " + str(score_value), True, (240, 255, 2))
    screen.blit(score, (x, y))


def game_over_text():
    over_text = over_font.render("GAME OVER", True, (240, 0, 0))
